...
private:
	...
	BYTE m_iScheduleMode;	// 10
	MapClass m_CrywolfMapAttr[3];	// 14
	BYTE m_iCrywolfState;	// F314C
	BYTE m_iOccupationState;	// F3150
	...
	BYTE m_StartTimeInfoCount;	// F4794
	...
	short m_iMonsterGroupNumberArray[MAX_CRYWOLF_MONSTER_GROUP];	// F48DC
	BYTE m_iMonsterGroupNumberCount;	// F492C
	int m_iMonsterGroupChangeAITime;	// F4930
	short m_iBossIndex;	// F4934
	short m_iBossGroupNumber;	// F4938
